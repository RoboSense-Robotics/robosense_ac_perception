...
def generate_launch_description():
    ...
    rviz2_node = Node(
        ...
        executable='rviz2',
        name='rviz2',
        arguments=['-d', rviz_config_file_promptda],
        output='screen'
    )
    ld = LaunchDescription()
    ld.add_action(promptda_node)
