...
set(CUR_SRCS
    ...
    src/promptda/config.cpp
    src/promptda/preprocess.cpp
    src/promptda/postprocess.cpp
    src/interface.cpp)

if(INFER_TENSORRT)
    list(APPEND CUR_SRCS src/promptda/promptda_nn_trt.cpp)
elseif(INFER_RKNN)
    list(APPEND CUR_SRCS src/promptda/promptda_nn_rk.cpp)
elseif(INFER_HBDNN)
    list(APPEND CUR_SRCS src/promptda/promptda_nn_hbdnn.cpp)
endif()
